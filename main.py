...
# ==================================================
# ✅ VERSI: KLIK SEKALI — TIDAK MEMBEKUKAN HALAMAN
# ==================================================
if st.query_params.get("proses_perintah") == "ya":
    ...
    try:
        ...
        # Ambil perintah terbaru — TANPA menunggu lama
        res = requests.get(
...
👇 Klik salah satu tombol di bawah:""",
        ...
        if perintah_diproses:
            ...
            st.info("ℹ️ Belum ada perintah baru. Ketik `/update 52` di Telegram, lalu klik tombol ini lagi.")
